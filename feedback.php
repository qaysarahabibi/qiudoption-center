                ...
                <div class="card-body">
                    <div class="container-sm">
                        <form action="" method="post">
                            ...
                            <h6>Help us grow by sending feedback!</h6>
                            <br>
                            <div class="mb-3">
                                <label class="form-label">Your Name</label>
                                <input type="text" class="form-control" name="ngaran" id="ngaran" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">What would you like to say?</label>
                                <input type="select" class="form-control" name="komen" id="komen" required>
                            </div>
